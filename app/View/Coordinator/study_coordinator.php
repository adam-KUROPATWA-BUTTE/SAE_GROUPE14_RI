...
<?php if ($action === 'view') : ?>
    ...
    <?php else : ?>
        ...
        <div class="form-back-button">
            <button onclick="window.location.href='<?= $buildUrl('index.php', ['page' => 'coordinateur-etude']) ?>'" class="btn-secondary">
                        ...
                        <table class="table-etudiants">
                            ...
                            <?php foreach ($students as $etudiant) : ?>
                                ...
                                <tr class="clickable-row" data-numetu="<?= htmlspecialchars($eNumEtu) ?>"
                                    onclick="window.location.href='<?= $buildUrl('index.php', ['page' => 'coordinateur-etude', 'action' => 'view', 'numetu' => $eNumEtu]) ?>'">
...
$activeMenu      = 'coordinateur-etude';
$userRole        = 'coordinateur_etude';
$metaDescription = $t([
