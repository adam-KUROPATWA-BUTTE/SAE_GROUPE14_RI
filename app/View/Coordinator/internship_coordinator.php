...
?>
    ...
    <header>
        ...
        <nav class="menu">
            ...
            <button class="active" onclick="window.location.href='<?= $buildUrl('index.php', ['page' => 'coordinateur-stage']) ?>'">
            ...
            <table id="table-etudiants">
                ...
                <?php foreach ($paginatedData as $etudiant):
                    ...
                    <tr class="clickable-row"
                        ...
                        onclick="window.location.href='<?= $buildUrl('index.php', ['page' => 'coordinateur-stage', 'action' => 'view', 'numetu' => $numEtu]) ?>'">
