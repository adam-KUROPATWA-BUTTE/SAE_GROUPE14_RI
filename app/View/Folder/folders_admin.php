...
<?php elseif ($action === 'view') : ?>
    ...
    <?php else: ?>
        ...
        <?php $dateLimite = $studentData['DateLimite'] ?? null; ?>
        ...
        <form method="post" action="index.php?page=update_student&lang=<?= htmlspecialchars($lang) ?>" enctype="multipart/form-data" class="creation-form">
            ...
            <div class="form-section documents-section">
                <h2 id="titre-pieces"><?= $t(['fr' => 'Pièces Justificatives','en' => 'Supporting Documents']) ?></h2>
                ...
                <div class="document-block">
                    ...
                    <?php $statutPhoto = $studentData['statuts']['photo'] ?? ''; ?>
                    <div class="statut-document-buttons" data-doc="photo">
                        <button type="button" class="btn-status conforme <?= $statutPhoto === 'conforme' ? 'active' : '' ?>" data-doc="photo" data-statut="conforme">✓ Conforme</button>
                        <button type="button" class="btn-status non-conforme <?= $statutPhoto === 'non_conforme' ? 'active' : '' ?>" data-doc="photo" data-statut="non_conforme">✗ Non conforme</button>
                    </div>
                </div>
                ...
                <div class="document-block">
                    ...
                    <?php $statutCv = $studentData['statuts']['cv'] ?? ''; ?>
                    <div class="statut-document-buttons" data-doc="cv">
                        <button type="button" class="btn-status conforme <?= $statutCv === 'conforme' ? 'active' : '' ?>" data-doc="cv" data-statut="conforme">✓ Conforme</button>
                        <button type="button" class="btn-status non-conforme <?= $statutCv === 'non_conforme' ? 'active' : '' ?>" data-doc="cv" data-statut="non_conforme">✗ Non conforme</button>
                    </div>
                </div>
                ...
                <div id="justificatif_convention" class="document-block">
                    ...
                    <?php $statutConvention = $studentData['statuts']['convention'] ?? ''; ?>
                    <div class="statut-document-buttons" data-doc="convention">
                        <button type="button" class="btn-status conforme <?= $statutConvention === 'conforme' ? 'active' : '' ?>" data-doc="convention" data-statut="conforme">✓ Conforme</button>
                        <button type="button" class="btn-status non-conforme <?= $statutConvention === 'non_conforme' ? 'active' : '' ?>" data-doc="convention" data-statut="non_conforme">✗ Non conforme</button>
                    </div>
                </div>
                ...
                <div id="lettre_motivation" class="document-block">
                    ...
                    <?php $statutLettre = $studentData['statuts']['lettre_motivation'] ?? ''; ?>
                    <div class="statut-document-buttons" data-doc="lettre_motivation">
                        <button type="button" class="btn-status conforme <?= $statutLettre === 'conforme' ? 'active' : '' ?>" data-doc="lettre_motivation" data-statut="conforme">✓ Conforme</button>
                        <button type="button" class="btn-status non-conforme <?= $statutLettre === 'non_conforme' ? 'active' : '' ?>" data-doc="lettre_motivation" data-statut="non_conforme">✗ Non conforme</button>
                    </div>
                </div>
                ...
                <form id="form-validation" method="POST" action="index.php?page=valider_documents&lang=<?= htmlspecialchars($lang) ?>">
                    ...
                    <div class="modal-section">
                        ...
                        <textarea
                                ...
                                placeholder="<?= $t([
                                        'fr' => 'Ex: Votre attestation d\'assurance doit être à jour pour l\'année en cours...',
                                        'en' => 'Ex: Your insurance certificate must be valid for the current year...'
                                ]) ?>"
                        ></textarea>
                    </div>
        ...
        <!-- Injection des données pour le JavaScript -->
        <script>
            <?php
