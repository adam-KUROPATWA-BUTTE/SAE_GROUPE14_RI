...
<head>
    <meta charset="utf-8">
    <title>Mise à jour dossier</title>
...
<div class="email-wrapper">
    ...
    <div class="email-body">
        ...
        <?php if (!empty($statutGlobal)): ?>
            ...
            $statutClass = $statutClasses[$statutGlobal] ?? 'email-status--depot';
            ?>
        ...
        <?php if (!empty($dateLimite)): ?>
            <p class="email-deadline">📅 Date limite de remise des pièces : <b><?= htmlspecialchars($dateLimite, ENT_QUOTES, 'UTF-8') ?></b></p>
        <?php endif; ?>

        <div class="email-cta email-cta--wide">
            <a href="https://ri-amu.app/" class="btn-primary btn-primary--lg">Consulter mon espace</a>
        </div>
        <p class="email-note" style="font-size:13px;color:#888;">Pour toute question, contactez le service Relations Internationales.</p>
