...
<body>
    ...
    <main>
        ...
        <ul>
            <li><strong>Comment réinitialiser le mot de passe d’un utilisateur ?</strong><br>
                Depuis la page de connexion, cliquez sur "Mot de passe oublié" et suivez la procédure.</li>
            <li><strong>Qui contacter en cas de problème technique ?</strong><br>
                Contactez le support informatique AMU à <a href="mailto:support@amu.fr">support@amu.fr</a>.</li>
        </ul>
        <h2>Contact</h2>
